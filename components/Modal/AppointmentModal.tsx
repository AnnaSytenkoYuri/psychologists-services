...
import { AppointmentFormData, appointmentSchema } from "@/validation/appointment.schema";
...
export default function AppointmentModal({isOpen, onClose, psychologist}: AppointmentModalProps) {
   const {
    register,
    handleSubmit,
        formState: { errors },
    ...
    return(
        ...
        >
          ...
          <div className={css.psychologist}>
            <Image src={psychologist.avatar} alt={psychologist.name} />
            <div>
